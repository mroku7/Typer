...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Cze 2018, 15:14
...
('root', '[{\"db\":\"worldcup\",\"table\":\"match\"},{\"db\":\"worldcup\",\"table\":\"bet\"},{\"db\":\"worldcup\",\"table\":\"users\"},{\"db\":\"worldcup\",\"table\":\"uzytkownicy\"}]');
...
('root', 'worldcup', 'match', '{\"sorted_col\":\"`match`.`id`  ASC\"}', '2018-05-25 12:45:52'),
('root', 'worldcup', 'users', '{\"CREATE_TIME\":\"2018-02-24 08:18:24\",\"col_visib\":[1,1,1,1,1],\"sorted_col\":\"`users`.`id` ASC\"}', '2018-05-08 09:05:09');
...
('root', '2018-02-09 19:51:10', '{\"lang\":\"pl\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
--
CREATE DATABASE IF NOT EXISTS `worldcup` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `worldcup`;
...
(1, 1, 'Lech Poznań', 'Jagiellonia', 0, 0),
(2, 1, 'Legia', 'Wisła', 0, 0),
(3, 1, 'Górnik', 'Korona', 0, 0),
(4, 1, 'Wisła Kraków', 'Zagłębie', 0, 0),
(5, 1, 'Arka', 'Cracovia', 0, 0),
(6, 1, 'Śląsk', 'Pogoń', 0, 0),
(7, 1, 'Piast', 'Lechia', 0, 0),
